...
%DEFINE CARBONOS_VER 'v0.1.2 (April 22, 2012)', 13, 'Copyright (C) 2012', 13, 0
...
; Includes
%include "init/init_64.asm"
%include "init/init_pci.asm"
%include "init/init_net.asm"
%include "init/init_hdd.asm"
